...
import sortingIcon from '../icons/sort-arrows.svg';
    ...
    <div className={`${styles.cityLine} ${styles.header}`}>
      <div className={styles.name}>
        <img
          ...
          className={sorting.field === 'name' ? styles.visible : undefined}
        />
      </div>
      <div className={styles.temp}>
        <img
          ...
          className={sorting.field === 'temp' ? styles.visible : undefined}
        />
      </div>
...
export const CitiesTable = ({
  ...
  const [sorting, setSorting] = useLocalStorage<Sorting>('citiesTableSorting', {
    field: 'name',
    order: 'asc',
  });
